    ...
    >
      <div className="page-shell">
        ...
        >
          ...
          <h2 className="section-title mt-5">Have something in mind?</h2>
...
const ContactItem: React.FC<ContactItemProps> = ({
  ...
  const content = (
    <motion.div className="mt-5 rounded-2xl border border-border bg-muted/60 p-4 transition-all duration-200 hover:border-primary/30 hover:bg-muted/60">
